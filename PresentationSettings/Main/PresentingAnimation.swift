...
public struct PresentingTransitionContext {
...
open class PresentingAnimation: NSObject {
    ...
    open func beforeAnimation(using transitionContext: PresentingTransitionContext) {
    ...
    ///
    /// - Parameter transitionContext: The context with everything needed for the animiation.
    open func performAnimation(using transitionContext: PresentingTransitionContext) {
        let finalFrameForVC = transitionContext.finalFrame
        let initialFrameForVC = transform(containerFrame: transitionContext.containerView.frame, finalFrame: finalFrameForVC)
    ...
    ///
    /// - Parameter transitionContext: The context with everything needed for the animiation.
    open func afterAnimation(using transitionContext: PresentingTransitionContext) {
...
extension PresentingAnimation: UIViewControllerAnimatedTransitioning {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let presentrContext = PresentingTransitionContext(containerView: containerView,
    ...
    private func animate(presentrContext: PresentingTransitionContext, transitionContext: UIViewControllerContextTransitioning, duration: TimeInterval) {
    ...
    private func animateWithSpring(presentrContext: PresentingTransitionContext, transitionContext: UIViewControllerContextTransitioning, duration: TimeInterval, delay: TimeInterval, damping: CGFloat, velocity: CGFloat) {
        beforeAnimation(using: presentrContext)
