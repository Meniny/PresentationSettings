...
public enum PresentationType {
    ...
    /// Describes the sizing for each PresentationSettings type. It is meant to be non device/width specific, except for the .custom case.
    ///
    ...
    /// Describes the position for each PresentationSettings type. It is meant to be non device/width specific, except for the .custom case.
    ///
    ...
    /// Associates each PresentationSettings type with a default transition type, in case one is not provided to the PresentationSettings object.
    ///
